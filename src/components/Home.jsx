                    ...
                    <CardContent className="p-0">
                        <div className="divide-y">
                            {topLeagues.map((league) => (
                                <div key={league.name} className="p-6 transition-colors hover:bg-gray-50">
                                    <div className="flex flex-wrap items-center justify-between gap-6">
                                        <div className="min-w-[200px] flex-1">
                                            <h3 className="mb-1 text-2xl font-bold">{league.name}</h3>
                                            <p className="text-gray-600">{league.region}</p>
                                        </div>
                                        <div className="min-w-[200px] flex-1">
                                            <div className="mb-1 text-sm text-gray-500">Active Players</div>
                                            <div className="text-lg font-bold">{league.players.toLocaleString()}</div>
                                        </div>
                                        <div className="min-w-[200px] flex-1">
                                            <div className="mb-1 text-sm text-gray-500">Prize Pool</div>
                                            <div className="text-lg font-bold text-blue-600">{league.prize}</div>
                                        </div>
                                        <div className="min-w-[200px] flex-1">
                                            <div className="mb-1 text-sm text-gray-500">Next Match</div>

                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 className="font-semibold">
                                        Senior Software Developer at Tech
                                        Innovators Inc.
                                    </h3>
                                    <p className="text-gray-600">
                                        2018 - Present
                                    ...
                                    <p className="mt-2">
                                        Leading development of cloud-native
                                        applications and mentoring junior
                                        developers.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 className="font-semibold">
                                        Software Developer at WebSolutions Co.
                                    </h3>
                                    <p className="text-gray-600">2015 - 2018</p>
                                    <p className="mt-2">
                                        Developed and maintained various client
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-gray-600">
                                    ...
                                    "WebFramework" - 2 days ago
                                </span>
                            </div>
                            <div className="flex items-center space-x-2">
                                <Calendar className="w-5 h-5 text-gray-400" />
                                <span className="text-gray-600">
                                    Published article "Future of Web

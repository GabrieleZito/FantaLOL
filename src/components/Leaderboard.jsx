...
import { plus } from "@/assets/icons/svgConstants";
import { z } from "zod";
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="grid gap-2 py-2">
                        ...
                        <div className="flex justify-end">{leagueError ? <p className="text-sm text-red-500">{leagueError}</p> : ""}</div>
                        <div className="grid grid-cols-4 items-center gap-4">
                            <Label htmlFor="name" className="text-right">
                                Name
                            </Label>

                            <Input id="name" {...register("name")} type="text" className="col-span-3" placeholder="Your Leaderboard" />
                        </div>
                        ...
                        <div className="flex justify-end">{errors.fee ? <p className="mt-2 text-sm text-red-500">{errors.fee.message}</p> : ""}</div>
                    </div>
